...
class ConversationCreatedTest extends TestCase
{
    ...
    {
        $channels = (new ConversationCreated())->broadcastOn();
    ...
    public function test_event_uses_dispatchable_trait(): void
    {
        $this->assertTrue(
            in_array(
                ...
                class_uses_recursive(ConversationCreated::class)
            )
        );
    }
    ...
    {
        $this->assertTrue(class_exists(ConversationCreated::class));
    }

    public function test_event_has_broadcast_on_method(): void
    {
        $this->assertTrue(method_exists(ConversationCreated::class, 'broadcastOn'));
    }
}
